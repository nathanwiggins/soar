...
- **Projects** — `Project_ID`, `Project_Title`, `Description`, `Status`, `Due_Date`, `Creator_ID`, `Color_Scheme`
- **Tasks** — `Task_ID`, `Project_ID`, `Task_Title`, `Description`, `Status`, `Priority`, `Due_Date`, `Creator_ID`, `Completed_By`, `Completed_At`
- **Subtasks** — `Subtask_ID`, `Task_ID`, `Subtask_Title`, `Status`
