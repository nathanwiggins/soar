...
| `Sort_Order` | Number | Per-user display order | Yes |
...
**Tasks**:
```
Task_ID | Project_ID | Task_Title | Description | Status | Priority | Created_Date | Due_Date | Creator_ID | Sort_Order | Completed_By | Completed_At
```
