...
- Drag and drop both task entries and project-due entries onto another day cell to immediately update their due dates. In multi-month view, the page auto-scrolls while dragging near the top or bottom edge.
