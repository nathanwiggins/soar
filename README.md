...
- Choose task status from `Not Started`, `Blocked by Dependency`, `Ready to Start`, `In Progress`, `Under Review`, `Needs Revision`, `Delayed`, `On Hold`, `Complete`
...
| `Status` | String | One of: `Not Started`, `Blocked by Dependency`, `Ready to Start`, `In Progress`, `Under Review`, `Needs Revision`, `Delayed`, `On Hold`, `Complete` | No |
